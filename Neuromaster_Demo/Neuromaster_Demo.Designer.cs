namespace Neuromaster_Demo
{
    partial class Neuromaster_Demo
    {
        ...
        private void InitializeComponent()
        {
            ...
            CbLogging.Location = new Point(18, 849);
            CbLogging.Margin = new Padding(2);
            CbLogging.Name = "CbLogging";
            CbLogging.Size = new Size(86, 24);
            ...
            label3.Location = new Point(18, 894);
            label3.Name = "label3";
            label3.Size = new Size(91, 20);
            label3.TabIndex = 176;
            label3.Text = "LogFile path";
            // 
            // LblLogFilePath
            // 
            LblLogFilePath.AutoSize = true;
            LblLogFilePath.Location = new Point(18, 932);
            LblLogFilePath.Name = "LblLogFilePath";
            LblLogFilePath.Size = new Size(52, 20);
            LblLogFilePath.TabIndex = 177;
            LblLogFilePath.Text = "lf path";
            // 
            // CbLogLevel
            // 
            CbLogLevel.FormattingEnabled = true;
            CbLogLevel.Location = new Point(150, 849);
            CbLogLevel.Name = "CbLogLevel";
            CbLogLevel.Size = new Size(151, 28);
            CbLogLevel.TabIndex = 179;
            CbLogLevel.SelectedIndexChanged += CbLogLevel_SelectedIndexChanged;
            // 
            // Neuromaster_Demo
            // 
